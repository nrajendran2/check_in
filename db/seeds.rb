...
youngin = User.create!(username: 'YoungMoney', name: 'Youngin Cho', photo_url: 'https://scontent.fatl1-2.fna.fbcdn.net/v/t1.0-9/17155306_10155331234160934_599035289131857202_n.jpg?_nc_cat=0&oh=49683803956c8fd0c2e15080e65e91b1&oe=5B643247'  )


monabag = Bag.create!(name: 'Mona' , weight: 32,  fragile: 'true', user_id:  mona.id  )

jaredbag =Bag.create!(name: 'Jared' , weight: 19,  fragile: 'false', user_id:  jared.id  )

 jamesbag =Bag.create!(name: 'James' , weight: 42,  fragile: 'true', user_id:  james.id  )

younginbag = Bag.create!(name: 'Youngin' , weight: 44,  fragile: 'false', user_id:  youngin.id  )
